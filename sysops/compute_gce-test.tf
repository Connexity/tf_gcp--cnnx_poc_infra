...
resource "google_compute_instance" "instance_gcemultidiskteststage002" {
  name = "gcemultidiskteststage002"
  machine_type = "n2-standard-4"
  project = "${var.gcp_project}"
  zone = "us-central1-c"
...
resource "google_compute_attached_disk" "attach_disk_gcemultidiskteststage002-shared-disk" {
  project = "${var.gcp_project}"
  disk     = google_compute_disk.gcedisk_gcemultidisktest-shared-disk.id
  instance = google_compute_instance.instance_gcemultidiskteststage002.id
  zone = "us-central1-c"
  mode = "READ_WRITE"
  device_name = "persistent-disk-1"
  depends_on = [google_compute_instance.instance_gcemultidiskteststage002]
}
