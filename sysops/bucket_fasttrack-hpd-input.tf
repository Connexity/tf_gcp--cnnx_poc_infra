resource "google_storage_bucket" "fasttrack-hpd-input_cnnx-poc-infra" {
  name          = "fasttrack-hpd-input_cnnx-poc-infra"
...
resource "google_storage_bucket_iam_policy" "fasttrack-hpd-input_cnnx-poc-infra_iam_policy" {
